...
class PurchaseReceiptSearch extends PurchaseReceipt
{
    public function rules()
    {
        return [
            [[
                'id', 'created_at', 'updated_at', 'updated_by', 'created_by', 'status', 'supplier_name',
                'lr_date', 'title', 'supplier_delivery_note', 'instructions', 'address_display',
                'supplier_address', 'contact_display', 'supplier', 'buying_price_list', 'terms',
                'supplier_warehouse', 'apply_discount_on', 'range', 'contact_person', 'in_words',
                'return_against', 'contact_mobile', 'posting_time', 'bill_no', 'tc_name',
                'rejected_warehouse', 'is_subcontracted', 'company', 'language', 'shipping_address',
                'posting_date', 'naming_series', 'currency', 'letter_head', 'shipping_rule', 'bill_date',
                'status', 'taxes_and_charges', 'transporter_name', 'remarks', 'shipping_address_display',
                'contact_email'
            ], 'safe'],
