...
class m220125_054523_030_create_table_purchase_order_item extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createIndex('item_id', '{{%purchase_order_item}}', ['item_id']);
        $this->createIndex('sales_quote_id', '{{%purchase_order_item}}', ['purchase_order_id']);
        $this->createIndex('account_id', '{{%purchase_order_item}}', ['account_id']);
    }
