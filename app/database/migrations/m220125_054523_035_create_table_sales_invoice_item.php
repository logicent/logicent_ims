...
class m220125_054523_035_create_table_sales_invoice_item extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createIndex('item_id', '{{%sales_invoice_item}}', ['item_id']);
        $this->createIndex('sales_quote_id', '{{%sales_invoice_item}}', ['sales_invoice_id']);
        $this->createIndex('account_id', '{{%sales_invoice_item}}', ['account_id']);
    }

    public function down()
    {
        $this->dropTable('{{%sales_invoice_item}}');
    }
}
